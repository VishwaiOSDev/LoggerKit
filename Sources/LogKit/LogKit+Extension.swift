...
protocol Loggable {
    static func info(_ message: String, shouldLogContext: Bool, file: String , function: String, line: Int)
    static func verbose(_ message: String, shouldLogContext: Bool, file: String , function: String, line: Int)
    static func debug(_ message: String, shouldLogContext: Bool, file: String , function: String, line: Int)
    static func warning(_ message: String, shouldLogContext: Bool, file: String , function: String, line: Int)
    static func error(_ message: String, shouldLogContext: Bool, file: String , function: String, line: Int)
}
...
public extension Log {
    ...
    static func verbose(_ message: String, shouldLogContext: Bool = true, file: String = #file, function: String = #function, line: Int = #line) {
        let context = Context(file: file, function: function, line: line)
        Log.handleLog(level: .verbose, message: message, shouldLogContext: shouldLogContext, context: context)
    }
    
    static func debug(_ message: String, shouldLogContext: Bool = true, file: String = #file, function: String = #function, line: Int = #line) {
        let context = Context(file: file, function: function, line: line)
